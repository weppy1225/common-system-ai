# ============================================================
# migrate_V9_user.ps1
# 사용자 이관: test → dev  (psql \copy 방식)
# 대상: mdm_user, mdm_user_biz, mdm_user_center
# 실행: .\migrate_V9_user.ps1
# ============================================================

. "$PSScriptRoot\db_config.ps1"

$SCRIPT_NAME = "V9__user"
$TSV_DIR     = $env:TEMP
$utf8NoBom   = New-Object System.Text.UTF8Encoding($false)
$TABLES      = @("mdm_user","mdm_user_biz","mdm_user_center")
...
[System.IO.File]::WriteAllText($tmpDel, "DELETE FROM mdm_user_center; DELETE FROM mdm_user_biz; DELETE FROM mdm_user;", $utf8NoBom)
...
$verifySql = "SELECT 'mdm_user' AS tbl, COUNT(*) AS cnt FROM mdm_user UNION ALL SELECT 'mdm_user_biz', COUNT(*) FROM mdm_user_biz UNION ALL SELECT 'mdm_user_center', COUNT(*) FROM mdm_user_center;"
