# ============================================================
# migrate_V3_biz.ps1
# 사업장 이관: test → dev  (psql \copy 방식)
# 대상: mdm_biz, mdm_biz_biz
# 실행: .\migrate_V3_biz.ps1
# ============================================================
...
[System.IO.File]::WriteAllText($tmpDel, "DELETE FROM mdm_biz_biz; DELETE FROM mdm_biz;", $utf8NoBom)
...
$verifySql = "SELECT 'mdm_biz' AS tbl, COUNT(*) AS cnt FROM mdm_biz UNION ALL SELECT 'mdm_biz_biz', COUNT(*) FROM mdm_biz_biz;"
