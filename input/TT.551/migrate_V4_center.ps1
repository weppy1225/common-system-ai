...
# 센터 이관: test → dev  (psql \copy 방식)
# 대상: mdm_center, mdm_biz_center
# 실행: .\migrate_V4_center.ps1
# ============================================================

. "$PSScriptRoot\db_config.ps1"

$SCRIPT_NAME = "V4__center"
$TSV_DIR     = $env:TEMP
$utf8NoBom   = New-Object System.Text.UTF8Encoding($false)
$TABLES      = @("mdm_center","mdm_biz_center")
...
[System.IO.File]::WriteAllText($tmpDel, "DELETE FROM mdm_biz_center; DELETE FROM mdm_center;", $utf8NoBom)
...
$verifySql = "SELECT 'mdm_center' AS tbl, COUNT(*) AS cnt FROM mdm_center UNION ALL SELECT 'mdm_biz_center', COUNT(*) FROM mdm_biz_center;"
