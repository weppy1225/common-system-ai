...
> 공통 골격은 [common 문서](../../../../../patterns/40-frontend/40-store/01-commCdStore.md)와 동일하다. 이 문서는 **OMS 고유 차이분만** 담는다.
...
OMS 공통코드 드롭다운/다중선택 컴포넌트는 → 실제 소스 `oms-fe/src/components/be/` (예: `searchItem/ZCodeSelect.vue`).
