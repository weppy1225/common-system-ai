...
스크립트 기본 경로: `C:\zinide\workspace\cloud-wms-doc\input\TT.551`
...
```powershell
& "C:\zinide\workspace\cloud-wms-doc\input\TT.551\migrate_all.ps1"
```
...
예) 인수가 `V3` 이면:
```powershell
& "C:\zinide\workspace\cloud-wms-doc\input\TT.551\migrate_V3_biz.ps1"
```
