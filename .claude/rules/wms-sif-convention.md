---
description: "[WMS 전용] SIF 외부연동(ERP/OMS/WES/DLV) 코드 작성·수정 시 적용. sif/ 하위 E2W(수신)·W2E(송신) 개발, Retrofit2 API 인터페이스, SIF 전용 예외, sif_* 이력 테이블 처리 패턴을 정의한다. WMS 이외 시스템에는 적용하지 않는다."
paths:
  - "**/sif/**"
---
