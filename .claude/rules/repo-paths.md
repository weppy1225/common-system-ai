...
```
workspace/
├── wms-{프로젝트코드}-ai/    # AI 허브. 스킬·규칙·화면설계(30-domain)·프로토타입(50-prototype) 보유. 스킬 실행 위치(CWD)
...
| `30-domain/`, `50-prototype/`, `patterns/`, `deliverables/` 화면설계·문서 | `$AI_DIR` (허브, CWD) | `$AI_DIR/30-domain/30-wms-business/{메뉴코드}/...` |
