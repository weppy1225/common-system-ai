#!/usr/bin/env python3
"""PI_421_WIN 2단계 — 템플릿 복사 + 데이터 채우기 + Sheet1 통계 갱신 (Windows 전용).
...
PI_421 원본과 동일하나 BASE_DIR 만 `Path(__file__).resolve().parents[4]` 로
자동 추론하여 Windows/WSL 어느 환경에서도 정상 동작한다.
"""
...
# .claude/skills/PI_421_WIN/scripts/02_generate_excel.py
# parents[4] = 프로젝트 루트
