...
- `$UI_MD` (`30-domain/{메뉴코드}/{메뉴코드}-02-ui.md`) — UI 설계서 (화면 구성, 필드 목록, 업무 흐름)
- `$WIREFRAME` — 화면 프로토타입 (PC: `30-domain/{메뉴코드}/{메뉴코드}-02-wireframe.html` / PDA: `50-prototype/20-mobile/…/{메뉴코드대문자}.html`)
