 ...
 *
 * 입력:  output/05 이행(TT)/tmp_541/capture_config.json
 * 출력:
 *   output/05 이행(TT)/tmp_541/screens/{메뉴코드}/01-main.png
 *   output/05 이행(TT)/tmp_541/screens/{메뉴코드}/02-search-result.png
 *   output/05 이행(TT)/tmp_541/screens/{메뉴코드}/03-register-popup.png  (선택)
 *   output/05 이행(TT)/tmp_541/screens/{메뉴코드}/04-row-selected.png    (선택)
 *   output/05 이행(TT)/tmp_541/screens/{메뉴코드}/05-edit-popup.png      (선택)
 *   output/05 이행(TT)/tmp_541/screens/{메뉴코드}/coords.json
 *
 * 표준 시나리오:
...
// repo root = .claude/skills/TT_541_WIN/scripts/ 의 parents[3]
