...
입력:
  output/05 이행(TT)/tmp_541/capture_config.json
  output/05 이행(TT)/tmp_541/screens/{메뉴코드}/*.png
...
# ── 경로 (스크립트 위치 기준 동적 계산) ────────────────────────
# 본 스크립트는 .claude/skills/TT_541_WIN/scripts/ 안에 있다.
# parents[0]=scripts  parents[1]=TT_541_WIN  parents[2]=skills  parents[3]=.claude  parents[4]=repo root
