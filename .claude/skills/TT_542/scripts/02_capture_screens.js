#!/usr/bin/env node
/**
 * [TT_542] 3단계 — Playwright 헤드리스 화면 캡처
 *
 * 사용법:
...
// repo root = .claude/skills/TT_542/scripts/ 의 parents[3]
const SCRIPT_DIR = __dirname;
const REPO_ROOT = path.resolve(SCRIPT_DIR, '..', '..', '..', '..');
const TMP_DIR = path.join(REPO_ROOT, 'deliverables', '30-output', '05 이행(TT)', 'tmp_542');
...
const VIEWPORT = cfg.viewport || { width: 390, height: 844, isMobile: true };
...
(async () => {
    ...
    const ctx = await browser.newContext({
        ...
        userAgent: VIEWPORT.userAgent || 'Mozilla/5.0 (Linux; Android 10; SM-G975N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.0.0 Mobile Safari/537.36',
