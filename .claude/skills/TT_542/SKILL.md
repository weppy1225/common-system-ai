...
> - 메뉴명 보완 출처: `prototype/mobile/{그룹m}/{메뉴코드대문자}.html` 에서 `<title>`
...
3. `spec/{메뉴}/{메뉴}-02-ui.md` 및 `prototype/mobile/{그룹m}/{메뉴}.html` 에서 메뉴명 보완
...
- `prototype/mobile/{그룹m}/{메뉴}.html` 이 있으면 HTML의 텍스트 기준 참조
