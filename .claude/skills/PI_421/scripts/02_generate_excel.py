...
입력: deliverables/30-output/04 구현(PI)/tmp/tests.json
...
TEMPLATE = BASE_DIR / "deliverables" / "10-templates" / "04 구현(PI)" / "PI_212-단위테스트보고서.xlsx"
TMP_JSON = BASE_DIR / "deliverables" / "30-output" / "04 구현(PI)" / "tmp" / "tests.json"
OUT_DIR = BASE_DIR / "deliverables" / "30-output" / "04 구현(PI)"
