 ...
 *
 * 입력:  deliverables/30-output/05 이행(TT)/tmp_541/capture_config.json
 * 출력:
 *   deliverables/30-output/05 이행(TT)/tmp_541/screens/{메뉴코드}/01-main.png
 *   deliverables/30-output/05 이행(TT)/tmp_541/screens/{메뉴코드}/02-search-result.png
 *   deliverables/30-output/05 이행(TT)/tmp_541/screens/{메뉴코드}/03-register-popup.png  (선택)
 *   deliverables/30-output/05 이행(TT)/tmp_541/screens/{메뉴코드}/04-row-selected.png    (선택)
 *   deliverables/30-output/05 이행(TT)/tmp_541/screens/{메뉴코드}/05-edit-popup.png      (선택)
...
// repo root = .claude/skills/TT_541/scripts/ 의 parents[3]
