---
name: PI-be-inven
description: BE 재고 확정 TxComp 개발 (InvenManager iw/ow/im/ad/rt 연동). "입고 확정 만들어줘", "출고 확정 개발해줘", "재고 모듈 만들어줘", "InvenManager 연동해줘", "재고 증감 처리 만들어줘" 요청 시 사용. /PI-be-inven {메뉴코드}
user-invocable: true
