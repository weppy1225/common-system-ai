...
# -*- coding: utf-8 -*-
"""
[TT_543_WIN] 4단계 — 운영자 매뉴얼 PPTX 생성 (템플릿 기반, python-pptx, Windows 경로)
...
# 본 스크립트는 .claude/skills/TT_543_WIN/scripts/ 안에 있다.
# parents[0]=scripts  parents[1]=TT_543_WIN  parents[2]=skills
