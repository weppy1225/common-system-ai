#!/usr/bin/env python3
"""PI_421_BASH 1단계 — JUnit 테스트 메서드 스캔 (WSL/Linux/Mac).
...
WSL/Linux/macOS 어느 환경에서도 정상 동작한다.
"""
...
# .claude/skills/PI_421_BASH/scripts/01_scan_tests.py
# parents[0]=scripts  parents[1]=PI_421_BASH  parents[2]=skills
