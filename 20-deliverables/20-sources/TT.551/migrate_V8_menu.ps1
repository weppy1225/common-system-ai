# ============================================================
# migrate_V8_menu.ps1
# 메뉴 이관: test → dev  (psql \copy 방식)
# 대상: sm_group, sm_menu, sm_menu_group, sm_menu_opt_config
# 실행: .\migrate_V8_menu.ps1
# ============================================================

. "$PSScriptRoot\db_config.ps1"

$SCRIPT_NAME = "V8__menu"
$TSV_DIR     = $env:TEMP
$utf8NoBom   = New-Object System.Text.UTF8Encoding($false)
$TABLES      = @("sm_group","sm_menu","sm_menu_group","sm_menu_opt_config")
...
[System.IO.File]::WriteAllText($tmpDel, "DELETE FROM sm_menu_opt_config; DELETE FROM sm_menu_group; DELETE FROM sm_menu; DELETE FROM sm_group;", $utf8NoBom)
...
$verifySql = "SELECT 'sm_group' AS tbl, COUNT(*) AS cnt FROM sm_group UNION ALL SELECT 'sm_menu', COUNT(*) FROM sm_menu UNION ALL SELECT 'sm_menu_group', COUNT(*) FROM sm_menu_group UNION ALL SELECT 'sm_menu_opt_config', COUNT(*) FROM sm_menu_opt_config;"
