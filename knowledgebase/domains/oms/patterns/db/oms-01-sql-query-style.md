...
> 공통 SQL 서식 골격(대소문자·anchor 정렬·comma-first·and-first·INSERT/UPDATE/DELETE/UNION ALL 서식·종합 요약표)은 [common 문서](../../20-database/30-convention/01-sql-query-style.md)와 동일하다. 이 문서는 **OMS 고유 차이분만** 담는다.
