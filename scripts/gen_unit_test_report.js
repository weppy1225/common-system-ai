...
const MANAGER  = '신현규';
const TMPL = path.join(__dirname, '../template/04 구현(PI)/PI.212-단위테스트보고서.xlsx');
const OUTDIR = path.join(__dirname, '../output/04 구현(PI)');
const OUTFILE  = path.join(OUTDIR, `PI.212-단위테스트보고서_${PROJ_NM}_260506.xlsx`);
