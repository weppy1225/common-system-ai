...
tags:
  ...
  - label-print
related:
  - 10-src-pattern/40-frontend/30-component/01-search-section.md
  - 10-src-pattern/40-frontend/30-component/04-z-buttons.md
...
- `10-src-pattern/40-frontend/30-component/01-search-section.md` — SearchSection 내부 배치
- `10-src-pattern/40-frontend/30-component/04-z-buttons.md` — 편집 팝업 (LayerPopup) 규약
- `10-src-pattern/40-frontend/50-pattern/01-crud-list-page.md` — 검색 필드에 팝업 삽입 패턴
