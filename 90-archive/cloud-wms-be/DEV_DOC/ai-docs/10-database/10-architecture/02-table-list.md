...
> 상세 테이블 정의서: [01-mdm-tables.md](../90-schema/10-group/01-mdm-tables.md)
...
> 상세 테이블 정의서: [02-inbound-tables.md](../90-schema/10-group/02-inbound-tables.md)
...
> 상세 테이블 정의서: [03-return-tables.md](../90-schema/10-group/03-return-tables.md)
...
> 상세 테이블 정의서: [04-outbound-tables.md](../90-schema/10-group/04-outbound-tables.md)
...
> 상세 테이블 정의서: [05-inventory-tables.md](../90-schema/10-group/05-inventory-tables.md)
...
> 상세 테이블 정의서: [06-inventory-management-tables.md](../90-schema/10-group/06-inventory-management-tables.md)
...
> 상세 테이블 정의서: [07-inventory-count-tables.md](../90-schema/10-group/07-inventory-count-tables.md)
...
> 상세 테이블 정의서: [08-system-management-tables.md](../90-schema/10-group/08-system-management-tables.md)
...
> 상세 테이블 정의 (개별 파일): [sif_batch_history.md](../90-schema/20-tables/sif_batch_history.md)
...
> 상세 테이블 정의 (개별 파일): [wes_process_history.md](../90-schema/20-tables/wes_process_history.md)
