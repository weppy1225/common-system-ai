...
| `10-src-pattern/` | WEB/PDA 화면·DB·BE·FE 소스코드 패턴 표준화 |
| `20-deliverables/` | 산출물 템플릿(10)·원천자료(20)·생성결과물(30) |
...
| 명령어 | 설명 |
|---|---|
| `/SD_310_UI {메뉴코드}` | 화면요건 문서 대화형 작성 → `30-domain/{메뉴코드}/{메뉴코드}-02-ui.md` |
| `/SD_311 {메뉴코드}` | 프로토타입 생성 → `30-domain/{메뉴코드}/{메뉴코드}-02-wireframe.html` |
